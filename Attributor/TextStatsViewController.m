...
//{
//    [super viewDidLoad];
//    self.textToAnalyze = [[NSAttributedString alloc]
//                          initWithString:@"test" attributes:@{NSForegroundColorAttributeName:[UIColor greenColor],NSStrokeWidthAttributeName: @-3}];
//}
